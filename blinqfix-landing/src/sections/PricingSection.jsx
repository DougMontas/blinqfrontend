...
// // If you already have them installed, you’re good.
...
//   // Optional: override button behavior
//   onCustomerClick,
//   onProClick,
// }) {
//   const money = (n) =>
...
//     if (onProClick) return onProClick(e);
//     window.location.href = ctaProHref;
//   };

//   const handleCustomerClick = (e) => {
//     if (onCustomerClick) return onCustomerClick(e);
//     window.location.href = ctaCustomerHref;
//   };
...
//             Pricing built for speed <span className="bf-titleEm">— and fairness.</span>
//           </h2>

//           <p className="bf-subtitle">
//             Customers join free and pay per job. Service Pros can join free, or subscribe to a
//             zipcode to get priority job alerts.
//           </p>
//         </div>
...
//               <div className="bf-promoKicker">Limited-time launch promotion</div>
//               <div className="bf-promoText">
//                 <strong>First {promoFirstN} Service Pros</strong> get the <strong>Pro</strong>{" "}
//                 subscription <strong>FREE</strong> for <strong>{promoMonthsFree} months</strong>.
//                 Secure your zipcode early.
//               </div>
...
//             <button className="bf-btn bf-btnPro" onClick={handleProClick} type="button">
//               <Wrench size={18} />
//               Claim Pro Access
//               <ArrowRight size={18} />
//             </button>
...
//                 $0 <span className="bf-priceUnit">to join</span>
//               </div>
//               <div className="bf-priceNote">
//                 Pay for the job in-app. A small platform fee helps support fast dispatch &amp;
//                 secure payments.
//               </div>
//             </div>
...
//                 Transparent checkout: job total + <strong>{customerFeePercent}%</strong>{" "}
//                 BlinqFix platform fee
//               </li>
//               <li>
//                 <span className="bf-dot ok" />
//                 Fixed-price quote upfront (no surprise add-ons)
//               </li>
//               <li>
//                 <span className="bf-dot ok" />
...
//               <button className="bf-btn bf-btnPrimary" onClick={handleCustomerClick} type="button">
...
//             <div className="bf-priceRow">
//               <div className="bf-priceBig">
//                 $0 <span className="bf-priceUnit">to join (Free tier)</span>
//               </div>
//               <div className="bf-priceNote">
//                 Want priority alerts in a specific trade + zipcode? Subscribe and get notified
//                 first.
//               </div>
//             </div>
...
//                   {money(proZipPrice)}/mo <span className="bf-miniUnit">per zipcode</span>
//                 </div>
...
//                 <div className="bf-miniValue">
//                   {proSlotsMin}–{proSlotsMax} <span className="bf-miniUnit">pros</span>
//                 </div>
...
//               <li>
//                 <span className="bf-dot ok" />
//                 If no subscriber accepts, it’s sent to <strong>Free tier</strong> pros
//               </li>
//               <li>
//                 <span className="bf-dot ok" />
...
//               <div className="bf-flowText">Subscribed pros get notified first in their zipcode.</div>
//             </div>
//           </div>
...
//               <div className="bf-flowText">First pro to accept gets the job—no bidding wars.</div>
//             </div>
//           </div>
...
//               <div className="bf-flowText">Customers pay in-app; payouts are streamlined.</div>
//             </div>
//           </div>
//         </div>
...
//           Pricing and capacity may vary by market and trade. Promotional offer applies to qualified
//           early sign-ups while available.
//         </p>
//       </div>
...
//   background:
//     radial-gradient(800px 260px at 0% 0%, rgba(250,204,21,.18), transparent 60%),
//     rgba(255,255,255,.04);
...
// .bf-cardCustomer{
//   background:
//     radial-gradient(700px 380px at 0% 0%, rgba(88,166,255,.14), transparent 65%),
//     rgba(255,255,255,.04);
// }

// .bf-cardPro{
//   background:
//     radial-gradient(700px 380px at 0% 0%, rgba(34,197,94,.14), transparent 65%),
//     rgba(255,255,255,.04);
// }
...
// /* ====== MOBILE FIXES (your screenshot issues) ====== */
      ...
      <div className="bf-priceContainer">
        ...
        >
          ...
          <div className="bf-promoActions">
            ...
            <button className="bf-btn bf-btnCustomer" onClick={handleCustomerClick} type="button">
              <Zap size={18} />
              Request Service
              <ArrowRight size={18} />
            </button>
        ...
        <div className="bf-cardGrid">
          ...
          >
            ...
            <ul className="bf-list">
              <li>
                <span className="bf-dot ok" />
                Transparent checkout: job total + <strong>{customerFeePercent}%</strong> BlinqFix
                platform fee
              </li>
              <li>
                <span className="bf-dot ok" />
          ...
          >
            ...
            <ul className="bf-list">
              ...
              <li>
                <span className="bf-dot ok" />
                <strong>Keep 93% of the job plus gain a customer for life</strong> - 7% BlinqFix platform fee
              </li>
              <li>
                <span className="bf-dot ok" />
                <strong>First to accept</strong> gets the job
